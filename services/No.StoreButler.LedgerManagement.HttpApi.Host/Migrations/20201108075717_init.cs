...
namespace No.StoreButler.LedgerManagement.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "LedgerManagementtrade_category",
                columns: table => new
                {
                    id = table.Column<Guid>(nullable: false),
                    ...
                    pay_flow_type = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LedgerManagementtrade_category", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "LedgerManagementpay_trade",
                columns: table => new
                {
                    id = table.Column<Guid>(nullable: false),
                    extra_properties = table.Column<string>(nullable: true),
                    concurrency_stamp = table.Column<string>(maxLength: 40, nullable: true),
                    pay_method = table.Column<int>(nullable: false),
                    trade_status = table.Column<int>(nullable: false),
                    pay_amount = table.Column<long>(nullable: false),
                    pay_flow_type = table.Column<int>(nullable: false),
                    trade_category_id = table.Column<Guid>(nullable: false),
                    tenant_id = table.Column<Guid>(nullable: true),
                    creation_time = table.Column<DateTime>(nullable: false),
                    creator_id = table.Column<Guid>(nullable: true),
                    last_modification_time = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LedgerManagementpay_trade", x => x.id);
                    table.ForeignKey(
                        name: "FK_LedgerManagementpay_trade_LedgerManagementtrade_category_tr~",
                        column: x => x.trade_category_id,
                        principalTable: "LedgerManagementtrade_category",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LedgerManagementpay_trade_trade_category_id",
